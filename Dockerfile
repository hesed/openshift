...
ENV CONFIG_JSON=none CERT_PEM=none KEY_PEM=none VER=3.50.1
...
RUN apk add --no-cache --virtual .build-deps ca-certificates curl \
 ...
 && cd /v2raybin \
 && curl -L -H "Cache-Control: no-cache" -o v2ray.zip https://github.com/v2ray/v2ray-core/releases/releases/download/v$VER/v2ray-linux-64.zip \
 && unzip v2ray.zip \
